...
def client():
    ...
    try:
        pub_key = load_key("DigitalSignatures/Group/group_keys/member_0_public_key.json")
        scrt_key = load_key("DigitalSignatures/Group/group_keys/member_0_secret_key.json")
